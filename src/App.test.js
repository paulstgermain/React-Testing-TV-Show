...
test('component correctly receives show data', async () => {
    ...
    await waitFor(async () => screen.queryAllByText(/stranger things/i));

    expect(await screen.getAllByText(/stranger things/i)).toHaveLength(2);
});